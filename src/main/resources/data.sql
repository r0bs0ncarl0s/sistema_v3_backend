...
ALTER SEQUENCE rcf_perfil_id_seq RESTART WITH 4;
ALTER SEQUENCE rcf_recurso_id_seq RESTART WITH 4;

ALTER SEQUENCE IF EXISTS rcf_comunica_id_seq INCREMENT 1;
ALTER SEQUENCE IF EXISTS rcf_per_per_rec_id_seq INCREMENT 1;
ALTER SEQUENCE IF EXISTS rcf_perf_usu_id_seq INCREMENT 1;
ALTER SEQUENCE IF EXISTS rcf_perfil_id_seq INCREMENT 1;
ALTER SEQUENCE IF EXISTS rcf_recurso_id_seq INCREMENT 1;
ALTER SEQUENCE IF EXISTS rcf_usu_ver_id_seq INCREMENT 1;
